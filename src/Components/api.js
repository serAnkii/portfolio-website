export const data = [
  {
    ...
    description: "It is a decentralised clone of twitter",
  ...
  },
  {
    ...
    description:
      "A system to automate the process of taking attendence , using machine learning",
    group: "ml",
  ...
  },
  {
    ...
    description:
      "It is a system to detect weather a transaction is a fraud or a legit one , using machine learning",
    group: "ml",
