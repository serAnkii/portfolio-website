export const ele = [
  {
    ...
    outcome:
      "Developed a fully functional social media platform with key features similar to Twitter",
    Text_shadow: "red",
  ...
  },
  {
    ...
    outcome:
      "Developed a visually appealing and interactive platform to showcase my skills and experience",
    Text_shadow: "blue",
  ...
  },
  {
    ...
    outcome:
      "Developed an automated system to track attendance using facial recognition technology",
    Text_shadow: "green",
